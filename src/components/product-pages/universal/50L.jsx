...
import Universal50 from "../../../images/spillkit/universal-kit/universal50.png";

function Universal50L() {
  return (
    <>
      <div className="product-page">
        <h3 className="product-big-name">
          RESQ UNIVERSAL ABSORBENT SPILL KIT - 50 LTR/13 GALLON
        </h3>
        <div className="product-div">
          <div className="product-page__images">
            <div className="big-img">
              <img src={Universal50} alt="product" />
            </div>
          </div>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style={{ fontWeight: "bold" }}>57 piece </td>
                  </tr>
                  <tr>
                    <td></td>
                    ...
                    <td style={{ fontWeight: "bold" }}>20 x 16 x 12 inch </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td style={{ fontWeight: "bold" }}>weight</td>
                    <td style={{ fontWeight: "bold" }}>approx 5 kg </td>
                  </tr>
                  <tr>
                    <td></td>
