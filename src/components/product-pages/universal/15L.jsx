...
import Universal15 from "../../../images/spillkit/universal-kit/universal15.png";

function Universal15L() {
  return (
    <>
      <div className="product-page">
        <h3 className="product-big-name">
          RESQ UNIVERSAL ABSORBENT SPILL KIT - 15 LTR/4 GALLON
        </h3>
        <div className="product-div">
          <div className="product-page__images">
            <div className="big-img">
              <img src={Universal15} alt="product" />
            </div>
          </div>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style={{ fontWeight: "bold" }}>23 piece </td>
                  </tr>
                  <tr>
                    <td></td>
                    ...
                    <td style={{ fontWeight: "bold" }}>15 X 5 X 22 inch </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td style={{ fontWeight: "bold" }}>weight</td>
                    <td style={{ fontWeight: "bold" }}>approx 2 kg </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td style={{ fontWeight: "bold" }}>total contents</td>
