...
import Universal120 from "../../../images/spillkit/universal-kit/universal120.jpg"

function Universal120L() {
  return (
    <>
      <div className="product-page">
        <h3 className="product-big-name">
          RESQ UNIVERSAL ABSORBENT SPILL KIT - 120 LTR/32 GALLON
        </h3>
        <div className="product-div">
          <div className="product-page__images">
            <div className="big-img">
              <img src={Universal120} alt="product" />
            </div>
          </div>
            ...
            <div className="product-page__details">
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>9</td>
                    <td>venus half face mask (V500 + V7500)</td>
                    <td>1 piece</td>
                  </tr>
                  <tr>
                    <td>10</td>
                    <td>eyewash bottle</td>
                    <td>1 piece</td>
                  </tr>
                  <tr>
                    <td>11</td>
                    <td>barricading tape</td>
                    <td>1 roll</td>
                  </tr>
                  <tr>
                    <td>12</td>
                  ...
                  <tr>
                    ...
                    <td style={{ fontWeight: "bold" }}>128 piece </td>
                  </tr>
                  <tr>
                    <td></td>
                    ...
                    <td style={{ fontWeight: "bold" }}>24 X 20 X 16 inch </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td style={{ fontWeight: "bold" }}>weight</td>
                    <td style={{ fontWeight: "bold" }}>approx 12 kg </td>
                  </tr>
                  <tr>
                    <td></td>
