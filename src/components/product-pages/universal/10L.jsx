...
import Universal10 from "../../../images/spillkit/universal-kit/universal10.jpg";

function Universal10L() {
  return (
    <>
      <div className="product-page">
        <h3 className="product-big-name">
          RESQ CHEMICAL ABSORBENT SPILL KIT - 10 LTR/2.6 GALLON
        </h3>
        <div className="product-div">
          <div className="product-page__images">
            <div className="big-img">
              <img src={Universal10} alt="product" />
            </div>
          </div>
