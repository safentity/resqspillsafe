...
import Chemical120 from "../../../images/spillkit/chemical-kit/chemical120.png";

function Chemical120L() {
  return (
    <>
      <div className="product-page">
        <h3 className="product-big-name">
          RESQ CHEMICAL ABSORBENT SPILL KIT - 120 LTR/32 GALLON
        </h3>
        <div className="product-div">
          <div className="product-page__images">
            <div className="big-img">
              <img src={Chemical120} alt="product" />
            </div>
          </div>
