...
import Chemical30 from "../../../images/spillkit/chemical-kit/chemical30.jpg";

function Chemical30L() {
  return (
    <>
      <div className="product-page">
        <h3 className="product-big-name">
          RESQ CHEMICAL ABSORBENT SPILL KIT - 30 LTR/8 GALLON
        </h3>
        <div className="product-div">
          <div className="product-page__images">
            <div className="big-img">
              <img src={Chemical30} alt="product" />
            </div>
          </div>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style={{ fontWeight: "bold" }}>35 piece </td>
                  </tr>
                  <tr>
                    <td></td>
                    ...
                    <td style={{ fontWeight: "bold" }}>17 X 8 X 22 inch </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td style={{ fontWeight: "bold" }}>weight</td>
                    <td style={{ fontWeight: "bold" }}>approx 3.7 kg </td>
                  </tr>
                  <tr>
                    <td></td>
